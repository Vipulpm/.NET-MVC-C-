...
namespace BankTransaction.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public async Task<IActionResult> AddOrEdit([Bind("TransactionID,AccountNumber,BeneficiaryName,BankName,Code,Amount,Date")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TransactionID,AccountNumber,BeneficiaryName,BankName,Code,Amount,Date")] Transaction transaction)
        {
